...
/// Public mirror of the `COMPLETE_MARKER` constant so other
/// modules (notably the `cached_dir_size` helper in `source.rs`
/// that powers the `max_bytes` pre-flight in #193) can recognise
/// the marker file without poking at private constants.
